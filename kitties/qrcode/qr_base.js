...
var { calculateEC } = require("./error_code.js");
...
const getTemplate = function (message, ec_level) {
    var i = 1;
    var len;
...
const fillTemplate = function (message, template) {
...
const QR = function QR(text, ec_level, parse_url) {

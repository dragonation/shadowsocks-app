...
const fillFinders = function (matrix) {
    var N = matrix.length;
    for (var i = -3; i <= 3; i++) {
        for (var j = -3; j <= 3; j++) {
...
const fillAlignAndTiming = function (matrix) {
    var N = matrix.length;
    if (N > 21) {
        var len = N - 13;
...
const fillStub = function (matrix) {
    var N = matrix.length;
    for (var i = 0; i < 8; i++) {
        if (i != 6) {
...
const calculatePenalty = function (matrix) {
    var N = matrix.length;
    var penalty = 0;
    // Rule 1
    for (var i = 0; i < N; i++) {

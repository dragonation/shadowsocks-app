...
const exp = function (k) {
    while (k < 0) k += 255;
    while (k > 255) k -= 255;
    return EXP_TABLE[k];
};

const log = function (k) {
    if (k < 1 || k > 255) {
...
const generatorPolynomial = function (num) {
    if (POLYNOMIALS[num]) {
...
const calculateEC = function (msg, ec_len) {
...
module.exports.calculateEC = calculateEC;
